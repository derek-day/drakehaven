...
const Content = () => (
  ...
  >
      ...
      <h2 className='title mt-2 mb-5' style={{fontFamily:'House', letterSpacing:'0.3rem', fontSize: '6rem' }}>Drakehaven</h2>
      ...
      {/* <img className='hero-image' src='/herocomic.png' style={{width: "100%", filter: "saturate(0.85)"}} /> */}
      <img className='hero-image' src='/heroold.png' style={{width: "100%", filter: "saturate(0.85)"}} />
  </div>
